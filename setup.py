...
setup(
    ...
    entry_points={
        'xivo_confd.plugins': [
            ...
            'line_endpoint_sip_plugin = xivo_confd.plugins.line_endpoint_sip.plugin:Plugin',
            'line_endpoint_sccp_plugin = xivo_confd.plugins.line_endpoint_sccp.plugin:Plugin',
        ]
    }
)

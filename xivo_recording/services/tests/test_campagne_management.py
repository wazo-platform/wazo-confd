...
class TestCampagneManagement(unittest.TestCase):
    ...
    def setUp(self):
        ...
        queue_features_dao.id_from_name = Mock(return_value='1')
        queue_features_dao.queue_name = Mock(return_value=self.queue_name)
        queue_features_dao.get_display_name_number = Mock(

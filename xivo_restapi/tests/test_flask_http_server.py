...
from xivo_restapi import flask_http_server as server


class TestLoadResources(unittest.TestCase):

    @patch('xivo_restapi.flask_http_server._list_resources')
    @patch('xivo_restapi.flask_http_server._load_module')
    def test_load_resources(self, load_module, list_resources):
        ...
        load_module.assert_any_call('xivo_restapi.resources.resource1.routes')
        load_module.assert_any_call('xivo_restapi.resources.resource2.routes')

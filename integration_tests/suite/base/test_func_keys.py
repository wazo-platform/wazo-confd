...
@fixtures.extension()
@fixtures.device()
def test_list_user(user, line_sip, extension, device):
...
@fixtures.extension()
@fixtures.device()
def test_put_user_position(user, line_sip, extension, device):
...
@fixtures.extension()
@fixtures.device()
def test_delete_user_position(user, line_sip, extension, device):
...
@fixtures.user()
def test_get_user_position(user):

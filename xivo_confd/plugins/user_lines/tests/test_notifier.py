...
from xivo_confd.plugins.user_lines import notifier


class TestUserLineNotifier(unittest.TestCase):

    @patch('xivo_confd.plugins.user_lines.notifier.sysconf_command_association_updated')
    @patch('xivo_confd.plugins.user_lines.notifier.bus_event_associated')
    ...
    @patch('xivo_confd.plugins.user_lines.notifier.sysconf_command_association_updated')
    @patch('xivo_confd.plugins.user_lines.notifier.bus_event_dissociated')

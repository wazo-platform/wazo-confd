...
def invalid_destinations():
    return [
        ...
        {
            'type': 'application',
            'application': 'fax_to_mail',
            'email': s.random_string(81),
        },
        ...
        {'type': 'queue', 'queue_id': 1, 'skill_rule_id': 1, 'skill_rule_variables': 1},
        {
            ...
            'queue_id': 1,
            'skill_rule_id': 1,
            'skill_rule_variables': {'invalid;': 'char'},
        },
        {
            'type': 'queue',
            'queue_id': 1,
        ...
        },
        {
            'type': 'queue',
            'queue_id': 1,
            'skill_rule_variables': {'skill_rule_id': 'undefined'},
        },
        {'type': 'sound'},
...
def valid_destinations(
    ...
    return [
        ...
        {'type': 'application', 'application': 'directory', 'context': 'name'},
        {'type': 'application', 'application': 'disa', 'context': 'name'},
        {
            'type': 'application',
            'application': 'disa',
            'pin': '1234',
        ...
        {'type': 'application', 'application': 'disa', 'pin': None, 'context': 'name'},
        {
            'type': 'application',
            'application': 'fax_to_mail',
        ...
        {'type': 'queue', 'queue_id': queue['id']},
        {
            ...
            'skill_rule_variables': {'var1': 'value1'},
        },
        {
            'type': 'queue',
            'queue_id': queue['id'],
        ...
        {'type': 'sound', 'filename': 'filename_without_extension', 'skip': True},
        {'type': 'sound', 'filename': 'filename_without_extension', 'no_answer': True},
        {
            'type': 'sound',
        ...
        {'type': 'voicemail', 'voicemail_id': voicemail['id'], 'greeting': None},
        {
            'type': 'voicemail',
            'voicemail_id': voicemail['id'],
            'skip_instructions': True,

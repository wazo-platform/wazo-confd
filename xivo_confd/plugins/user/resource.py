...
parser.add_argument('call_transfer_enabled', type=Strict(bool), store_missing=False, nullable=False)
parser.add_argument('call_record_enabled', type=Strict(bool), store_missing=False, nullable=False)
parser.add_argument('online_call_record_enabled', type=Strict(bool), store_missing=False, nullable=False)
parser.add_argument('supervision_enabled', type=Strict(bool), store_missing=False, nullable=False)
parser.add_argument('ring_seconds', type=int, store_missing=False, nullable=False)
parser.add_argument('simultaneous_calls', type=int, store_missing=False, nullable=False)
parser.add_argument('caller_id', type=Strict(unicode), store_missing=False, nullable=False)

...
@patch('xivo_confd.plugins.line_extension.notifier.associated')
@patch('xivo_confd.plugins.line_extension.service.association_manager')
...
@patch('xivo_confd.plugins.line_extension.notifier.dissociated')
@patch('xivo_confd.plugins.line_extension.service.association_manager')

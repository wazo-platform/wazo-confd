...
from xivo_confd.plugins.line_extension.manager import AssociationManager
from xivo_confd.plugins.line_extension.manager import IncallAssociator
from xivo_confd.plugins.line_extension.manager import InternalAssociator
from xivo_confd.plugins.line_extension.manager import build_manager


class TestBuildManager(unittest.TestCase):

    @patch('xivo_confd.plugins.line_extension.manager.line_device_validator')
    @patch('xivo_confd.plugins.line_extension.manager.extension_validator')
    @patch('xivo_confd.plugins.line_extension.manager.extension_dao')
    @patch('xivo_confd.plugins.line_extension.manager.incall_dao')
    @patch('xivo_confd.plugins.line_extension.manager.user_line_dao')
    @patch('xivo_confd.plugins.line_extension.manager.line_extension_dao')
    @patch('xivo_confd.plugins.line_extension.manager.context_dao')
    @patch('xivo_confd.plugins.line_extension.manager.line_extension_validator')
    @patch('xivo_confd.plugins.line_extension.manager.IncallAssociator')
    @patch('xivo_confd.plugins.line_extension.manager.InternalAssociator')
    @patch('xivo_confd.plugins.line_extension.manager.AssociationManager')

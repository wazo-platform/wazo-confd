...
class TestAPICampaigns(unittest.TestCase):
    ...
    def setUp(self):
        self.patcher_campaigns = patch("xivo_restapi.rest.API_campaigns.CampagneManagement")
        ...
        self.patch_campaigns_helper = patch("xivo_restapi.rest.API_campaigns.CampaignsHelper")

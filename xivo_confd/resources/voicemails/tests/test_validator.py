...
from xivo_dao.resources.voicemail import validator
...
class TestValidateCreate(unittest.TestCase):
    ...
    @patch('xivo_dao.resources.voicemail.validator.validate_model')
    @patch('xivo_dao.resources.voicemail.validator.validate_number_context')
...
class TestValidateEdit(unittest.TestCase):
    ...
    @patch('xivo_dao.resources.voicemail.validator.validate_existing_number_context')
    @patch('xivo_dao.resources.voicemail.validator.validate_model')
